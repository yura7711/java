...
function getCodeServer() {
  ...
  if (idx >= 0) {
    ...
    idx = query.indexOf("gwt.codesvr.webapp=");
    idx += (13 + "webapp".length);  // 
  }
  if (idx >= 0) {
...
//# sourceMappingURL=http://127.0.0.1:9876/sourcemaps/webapp/_sourcemap.json 
//# sourceURL=webapp-0.js
